...
class FileBackedTaskManagerTest {
    ...
    public void createNewTasks() {
        ...
        // Создаем задачи с полными параметрами
        ...
        taskManager.createTask(TaskType.SUBTASK, "подзадача 1", "Выполнить работу", 1,
                TaskProgress.NEW, "2005-12-14T00:00", 120, "2005-12-17T02:00");
        ...
        // Создаем задачи для сравнения с полными параметрами
    ...
    public void deleteTaskById() {
        ...
        assertNull(taskManager.getTask(0), "Объект должен быть удален");

        taskManager.deleteTasksById(TaskType.SUBTASK, 2);
        assertNull(taskManager.getSubtask(2), "Объект должен быть удален");

        taskManager.deleteTasksById(TaskType.EPIC, 1);
        assertNull(taskManager.getEpic(1), "Объект должен быть удален");
